...
default_hosts = ['localhost', '127.0.0.1', 'mathhint-collector.onrender.com']
...
# Render用 - DATABASE_URL で自動設定
# ローカル開発: SQLite、本番環境: PostgreSQL
if os.getenv('DATABASE_URL'):
    # Render環境（DATABASE_URLが設定されている）
    DATABASES = {
...
# 2FA（OTP）設定
# ============================================
OTP_TOTP_ISSUER = 'MathHint Collector'
OTP_LOGIN_URL = '/login/'
