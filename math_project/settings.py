...
# デフォルトはFalse（本番環境用）。ローカルは.envでDEBUG=Trueを設定
...
# DATABASE_URL が設定されている場合は PostgreSQL を使用
...
# セッション設定強化
# ============================================
SESSION_ENGINE = 'django.contrib.sessions.backends.db'  # DB 保存
SESSION_COOKIE_SECURE = not DEBUG  # 本番環境（HTTPS）ではTrue
...
AXES_VERBOSE = True
AXES_LOCKOUT_TEMPLATE = 'math_app/lockout.html'  # ロックアウトテンプレート

# ============================================
# 認証認可の追加設定
# ============================================
AUTHENTICATION_BACKENDS = [
    'axes.backends.AxesBackend',  # django-axes
...
# メール設定
# ============================================
EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'  # 開発環境：コンソール出力
# EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'  # 本番環境：SMTP
# EMAIL_HOST = 'smtp.gmail.com'
# EMAIL_PORT = 587
# EMAIL_USE_TLS = True
# EMAIL_HOST_USER = os.environ.get('EMAIL_HOST_USER')
# EMAIL_HOST_PASSWORD = os.environ.get('EMAIL_HOST_PASSWORD')
DEFAULT_FROM_EMAIL = 'noreply@mathhint-collector.com'
